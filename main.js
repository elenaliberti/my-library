const { app, BrowserWindow, ipcMain, dialog, shell, session, nativeImage, nativeTheme } = require('electron')

// The app is light-only by request. Pin the OS appearance Electron reports to the renderer
// (its prefers-color-scheme, native form controls, scrollbars and the titlebar vibrancy) to light,
// regardless of the Mac's system Dark Mode setting.
